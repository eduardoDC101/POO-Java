...
stmt.execute(comando.toUpperCase());
    ...
    //atribut do tipo ResultSet utilizando para realizar consultas
    ...
    @param opcao, que vem da classe Cliente
    @return Um ResultSet com os dados do cliente.
    
    */
    public ResultSet consultarCliente(ClienteDTO clienteDTO, int opcao){
        try{
            //Chama o metodo que esta na classe Conexão para Abrir o banco de dados
            ConexaoDAO.ConnectDB();
            stmt = ConexaoDAO.con.createStatement();
           String comando ="";
           switch(opcao){
